...
<body>
    ...
    ?>
      <div class="col30">
        <div class="profile-img">
          <img src="<?php echo $_SESSION['username']."/profile/{$row['profile_img']}";?>" alt="">
        </div>
        <div class="profile-name"><h3><?php echo $_SESSION['username'];?></h3></div>
        ...
        <div class="update-profile">
          <div class="modal profile-modal" id="ex2">
            <input type="text" name="username" id="update-username" placeholder="username" ><br>
            <input type="email" name="username" id="update-email" placeholder="email" ><br>
            <input type="submit" value="update" class = "update">
          </div>
          <a href = "#ex2" rel = "modal:open" class = "profile-btn update-btn">update profile</a>
        </div>
        ...
        <div class="row-upper">
          <div class="col-img">
            <div class="profile-img">
              ...
              <a href="#ex4" rel = "modal:open"><img src="<?php echo $_SESSION['username']."/profile/{$row['profile_img']}";?>" alt=""></a>
            </div>
          </div>
          <?php
            $sql1 = "SELECT * FROM posts WHERE username = '{$_SESSION["username"]}'";
            $result1 = mysqli_query($conn,$sql1);
            $no_posts = mysqli_num_rows($result1);
          ?>
          <div class="col-info">
            <div class="profile-name"><h3>Name : </h3><p><?php echo $_SESSION['username'];?></p></div>
            <div class="no-posts"><h3> Posts : </h3><p><?php echo $no_posts?></p></div>
             <div class="upgrade">
              <div class="update-profile-responsive">
                ...
                <div class="modal profile-modal-responsive" id="ex5">
                  <input type="text" name="username" id="update-username-responsive" placeholder="username" ><br>
                  <input type="email" name="email" id="update-email-responsive" placeholder="email" ><br>
                  <input type="submit" value="update" class = "update">
                </div>
  ...
  <script>
    $(document).ready(function(){
      function loadPost(){
        $.ajax({
          url : "profile-post.php?indid=<?php echo $_SESSION['id'];?>",
          type : "POST",
